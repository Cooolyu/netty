...
public class OrderPrep extends JFrame {

	private JPanel contentPane;
	private JButton button_1;
	private static OrderPrep frame;
	...
	public OrderPrep() {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//插入记录
				String insertsql = "insert into clientMsg ( message , addTime , type) values ('"+carNum.getText()+'-'+orderTime.getText()+"-"+orderLong.getText()+"','"+System.currentTimeMillis()+"','order')";                                        
				JDBCUtil jdbcUtil = new JDBCUtil();
				...
				System.out.println(resultSet.getString("Type"));
					if(resultSet.getString("Type").equals("order"))
